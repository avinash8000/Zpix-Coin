(function ($) {
  var cryptohousescripts = {
    menu: function () {
      // Mobile Menu
      $(".h-menu li ul").parent("li").append("").addClass("has-child");
      $(".h-menu li .megamenu").parent("li").addClass("has-megamenu");
      $(".h-menu li .megamenu").parent("li").children("a").append("");
      $(".h-menu li .megamenu").parent("li").append("");
    ...
    countdown: function () {
      ...
      if ($(".countdown-clock").length) {
        $(".countdown-clock").countdown("2024/10/10", function (event) {
    ...
    counterup: function () {
      ...
      if ($(".counter-wrap, .cripto-batch-wrapper").length) {
        ...
        $(window).scroll(function () {
          var oTop =
            $(".counter-wrap , .cripto-batch-wrapper").offset().top -
            window.innerHeight;
    ...
    accordion_two: function () {
      $(".single-accordion, .acorn-click").click(function () {
        if ($(this).hasClass("active")) {
          ...
          $(".accordion-wrapper")
            .find(".single-accordion,.acorn-click")
            .removeClass("active")
            .find(".accordion-body")
            .slideUp();
    ...
    cripto_accordion: function () {
      $(".cripto-single-accordion").click(function () {
        $(this)
          .toggleClass("active")
          .children(".cripto-accordion-body")
          .slideToggle()
          .parents(".cripto-single-accordion")
          .siblings()
          .removeClass("active")
          .children(".cripto-accordion-body")
          .slideUp();
      ...
      var addClassOnScroll = function () {
        ...
        $(".section").each(function (index, elem) {
          ...
          if (
            ...
            $(".h-menu-wrap ul li a[href='#" + elemId + "']").addClass(
              "active"
            );
          }
        });
